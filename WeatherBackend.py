...
# Create app
app = Flask(__name__)
CORS(app, resources={r"/current-weather": {"origins": ["http://localhost:3000", "https://gayanrajapakshage.github.io"]}})
CORS(app, resources={r"/weekly-forecast": {"origins": ["http://localhost:3000", "https://gayanrajapakshage.github.io"]}})
CORS(app, resources={r"/search-city": {"origins": ["http://localhost:3000", "https://gayanrajapakshage.github.io"]}})
